-- Highfil CRM - Supabase Schema Migration
...
-- Seed default users (password = 'admin123' and 'operador1' hashed with bcrypt)
INSERT INTO users (username, password, role, name)
SELECT 'admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'supervisor', 'Supervisor'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE username = 'admin');

INSERT INTO users (username, password, role, name)
SELECT 'operador1', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'operator', 'Operador 1'
